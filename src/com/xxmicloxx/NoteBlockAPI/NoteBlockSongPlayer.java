...
/**
 * Created with IntelliJ IDEA. User: ml Date: 07.12.13 Time: 12:56
 */
public class NoteBlockSongPlayer extends SongPlayer {
	...
	public void playTick(Player p, int tick){
		...
		byte playerVolume = NBAPI.getPlayerVolume(p);
		...
		for (Layer l : song.getLayerHashMap().values()) {
			...
			p.playSound(noteBlock.getLocation(), Instrument.getInstrument(note.getInstrument()), (l.getVolume() * (int) volume * (int) playerVolume) / 1000000f, NotePitch.getPitch(note.getKey() - 33));
		}
	}
}
