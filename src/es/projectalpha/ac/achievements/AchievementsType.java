...
public enum AchievementsType {
	...
	AchievementsType(String dispName, String message, double reward){
		this.dispName = dispName;
		this.message = message;
		this.reward = reward;
	}

	AchievementsType(String dispName, String message){
		this.dispName = dispName;
		this.message = message;
		this.reward = 0.0D;
	}

	AchievementsType(String dispName){
		this.dispName = dispName;
		this.message = "";
		this.reward = 0.0D;
	}

	AchievementsType(String dispName, double reward){
		this.dispName = dispName;
		this.message = "";
		this.reward = reward;
	}
